...
// cmake -DCMAKE_BUILD_TYPE=Release -DTd_DIR=~/sirius-01-19/sirius_app/td-master/example/java/td/lib/cmake/Td -DCMAKE_INSTALL_PREFIX:PATH=.. ..
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        client.send(new TdApi.AddProxy(server, port, true, new TdApi.ProxyTypeHttp(username, password, false)), defaultHandler);
        // System.out.println("Proxy");
        // test Client.execute
        // defaultHandler.onResult(Client.execute(new TdApi.GetTextEntities("@telegram /test_command https://telegram.org telegram.cme @gif @test")));
